...
describe("MAPO ServiceV3 start test", () =>{
    ...
    async function deployMosContractFixture() {
        ...
        let mosContract = await ethers.getContractFactory("MockMapoServiceV3");
    ...
    describe("0.8.7 to 0.8.20 upgrade test",() =>{
        it('mosMessage set ', async function () {
            ...
            await echo.addCorrespondence("5",echo.address,true);
        ...
        it('transferIn start test ', async function () {
            let MapoServiceV3 = await ethers.getContractFactory("MapoServiceV3");
            let mapoServiceV3 = await MapoServiceV3.deploy();
            console.log("MapoService new address:",mapoServiceV3.address);

            await (await mos.upgradeTo(mapoServiceV3.address)).wait()

            let data = await echo.getData("Fine","How are you");
            ...
            let receiptProof =
                ""
                +echo.address.substring(2)
                +""
                +echo.address.substring(2)
